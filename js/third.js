...
const showMenu= (toggleId, navId) =>{
  ...
  gsap.from(".home__greeting, .home__name, .home__professional , .home__button, .doodle", {opacity:0,duraction:2, delay:1, y:25, ease:'expo.out', stagger:.2})
  ...
  /*===== HIGHLIGHTING TEXT AUTOMATICALLY =====*/ 
  setTimeout(function() {
